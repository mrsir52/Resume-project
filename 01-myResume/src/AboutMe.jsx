...
import bstrap from './bootstrap-plain.svg'
import github1 from './github1l.svg'
                ...
                <div class="grid-1 grid-style">
                    <div class="col-5">
                        ...
                        <img class="icon" src={bstrap} width={50} height={50} alt="react logo" />
                            ...
                            <a href="https://www.linkedin.com/in/manny-torres-ut/"><img class="icon link btn" src={link} width={50} height={50} alt="react logo" /></a>
                            <a href="https://github.com/mrsir52"><img class="icon link btn" src={github1} width={50} height={50} alt="react logo" /></a>
                        </div>
                    </div>
                    <div class="col-7">
                        <h2>About Me</h2>
